	...
	angular.module("optc").run(function ($rootScope, $timeout, $storage) {
		...
		var tableFilter = function (settings, data, index) {
			...
			if (
				...
				[
					4322, 4323, 4324, 4325, 4307, 4308, 4314, 4321, 4318, 4326, 
					4317, 4315, 4316, 2940, 2944, 2938, 2942, 2936, 2946, 2948, 
					2950, 2952, 3884, 3886, 4128, 4162, 4131, 4170, 4202, 4227, 
					4266, 4290, 4282, 4291, 4292, 4293, 4294
				].indexOf(id) == -1
			)
				return false;
